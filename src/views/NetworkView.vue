    ...
    <main class="ml-2">
        <section>
            <ol class="relative border-l border-gray-200 dark:border-gray-700">
                <li class="flex justify-between mb-10 ml-4" v-for="i in store.Networks" :key="i.id">
                    <div :id="`e${i.id}`">
                        <div
                ...
                <li class="ml-4 mb-10">
                    <form v-show="add" @submit.prevent="createProduct">
                        <div>
                            <div class="relative z-0 w-full mx-1 mb-4 group">
                                ...
                                <label for="floating_email"
                                    class="peer-focus:font-medium absolute text-md text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">network
                                    icon</label>
                            </div>
                            <div class="relative z-0 w-full mx-1 mb-4 group">
                                <input v-model="form.name" type="text" name="floating_email" id="floating_email"
                                    class="block py-2.5 px-0 w-1/2 mb-1 text-sm font-bold leading-none dark:text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " required />
                                <label for="floating_email"
                            ...
                            <div class="relative z-0 w-full mx-1 mb-4 group">
                                <input v-model="form.link" type="text" name="floating_email" id="floating_email"
                                    class="block py-2.5 px-0 w-[90%] mb-1 text-sm font-medium leading-none dark:text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                    placeholder=" " required />
                                <label for="floating_email"
                                    class="peer-focus:font-medium absolute text-md text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                                    network link
                        ...
                        <div v-show="add" class="flex justify-between items-center">
                            <button type="submit" class="text-white px-5 py-2 rounded-lg bg-[#3098ed]">Submit</button>
                            <a target="_blank" href="https://boxicons.com/?query=github"
                                class="bg-white py-1 px-4 rounded-lg shadow-md shadow-white font-bold">Get icon</a>
                        </div>
                    </form>
                    <button v-show="!add" @click="add = !add" class="text-white px-5 py-2 rounded-lg bg-[#3098ed]">Add
                        network</button>
                </li>
            </ol>
        </section>
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 space-y-6">
                            <form @submit.prevent="editProduct">
                                <div>
                                    <div class="relative z-0 w-full mx-1 mb-4 group">
                                        <input v-model="modal.icon" type="text" name="floating_email" id="floating_email"
                                            ...
                                            placeholder=" " required />
                                        <label for="floating_email"
                                            class="peer-focus:font-medium absolute text-md text-gray-500 duration-300 transmodal -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Network's
                                            icon</label>
                                    </div>
                                    <div class="relative z-0 w-full mx-1 mb-4 group">
                                    ...
                                    <div class="relative z-0 w-full mx-1 mb-4 group">
                                        <input v-model="modal.link" type="text" name="floating_email" id="floating_email"
                                            ...
                                            placeholder=" " required />
                                        <label for="floating_email"
                                            class="peer-focus:font-medium absolute text-md text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Network's
                                            link</label>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <button data-modal-hide="defaultModal" type="button" @click="form.editToggle = false"
